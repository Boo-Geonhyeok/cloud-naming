...
var app = (function () {
    ...
    */
    ...
    a:{var Oa$1="",Pa=function(){var a=x$1;if(Ka$1)return /rv:([^\);]+)(\)|;)/.exec(a);if(Ia$1)return /Edge\/([\d\.]+)/.exec(a);if(y)return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(La)return /WebKit\/(\S+)/.exec(a);if(Ha)return /(?:Version)[ \/]?(\S+)/.exec(a)}();Pa&&(Oa$1=Pa?Pa[1]:"");if(y){var Qa=Ma$1();if(null!=Qa&&Qa>parseFloat(Oa$1)){Na=String(Qa);break a}}Na=Oa$1;}var Ga={};
    ...
    */
    ...
    X$1.prototype.getResponseText=X$1.prototype.ga;X$1.prototype.send=X$1.prototype.ea;var createWebChannelTransport = function(){return new Td};var getStatEventTarget = function(){return Sb()};var ErrorCode$1 = Wb;var EventType = Xb;var Event = H;var Stat = {rb:0,ub:1,vb:2,Ob:3,Tb:4,Qb:5,Rb:6,Pb:7,Nb:8,Sb:9,PROXY:10,NOPROXY:11,Lb:12,Hb:13,Ib:14,Gb:15,Jb:16,Kb:17,nb:18,mb:19,ob:20};var FetchXmlHttpFactory = pd;var WebChannel = $b;
    var XhrIo = X$1;
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "modal-background svelte-1b6qbrg");
    			add_location(div0, file$4, 41, 0, 890);
    			add_location(hr, file$4, 45, 1, 1045);
    			attr_dev(div1, "class", "modal svelte-1b6qbrg");
    ...
    /* src/Detail.svelte generated by Svelte v3.49.0 */
    const file$3 = "src/Detail.svelte";
    ...
    // (33:0) {#each coordinate.titles as t}
    function create_each_block$1(ctx) {
    	let li;
    	let t0_value = /*t*/ ctx[4].title + "";
    	let t0;
    	let t1;
    	let t2_value = /*t*/ ctx[4].like + "";
    	let t2;
    	let t3;
    	let button;
    	let mounted;
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "^";
    			add_location(button, file$3, 33, 23, 892);
    			add_location(li, file$3, 33, 0, 869);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*upvote*/ ctx[1](/*t*/ ctx[4]))) /*upvote*/ ctx[1](/*t*/ ctx[4]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*coordinate*/ 1 && t0_value !== (t0_value = /*t*/ ctx[4].title + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*coordinate*/ 1 && t2_value !== (t2_value = /*t*/ ctx[4].like + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:0) {#each coordinate.titles as t}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*coordinate*/ ctx[0].titles;
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*coordinate*/ ctx[0].img)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "detailImg");
    			add_location(img, file$3, 30, 0, 776);
    			add_location(hr, file$3, 31, 0, 833);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "name", "");
    			attr_dev(input, "id", "");
    			add_location(input, file$3, 37, 4, 998);
    			add_location(button, file$3, 38, 4, 1036);
    			add_location(form, file$3, 36, 0, 946);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(form, "submit", prevent_default(/*uploadTitle*/ ctx[2]), false, true, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*coordinate*/ 1 && !src_url_equal(img.src, img_src_value = /*coordinate*/ ctx[0].img)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty & /*upvote, coordinate*/ 3) {
    				each_value = /*coordinate*/ ctx[0].titles;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	async function upvote(t) {
    		const coordinateRef = Da(cloudRef, coordinate.id, 'titles');
    		const titleRef = xa(coordinateRef, t.id);

    		await Tl(titleRef, {
    			title: { title: t.title, like: t.like + 1 }
    		});
    	}

    	async function uploadTitle(event) {
    		const comment = event.target[0].value;
    		await Al(Da(cloudRef, coordinate.id, 'titles'), { title: { title: comment, like: 1 } });
    		event.target[0].value = "";
    		blur();
    	}

    	const writable_props = ['coordinate', 'cloudRef'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('cloudRef' in $$props) $$invalidate(3, cloudRef = $$props.cloudRef);
    	};
    	...
    	return [coordinate, upvote, uploadTitle, cloudRef];
    }

    class Detail extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { coordinate: 0, cloudRef: 3 });
    		...
    		if (/*coordinate*/ ctx[0] === undefined && !('coordinate' in props)) {
    			console.warn("<Detail> was created without expected prop 'coordinate'");
    		}

    		if (/*cloudRef*/ ctx[3] === undefined && !('cloudRef' in props)) {
    			console.warn("<Detail> was created without expected prop 'cloudRef'");
    		}
    	}
    ...
    /* src/PinPoint.svelte generated by Svelte v3.49.0 */
    const file$2 = "src/PinPoint.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(img, "left", /*c*/ ctx[11].coordinate.x + "px");
    			set_style(img, "top", /*c*/ ctx[11].coordinate.y + "px");
    			set_style(img, "position", "absolute");
    			if (!src_url_equal(img.src, img_src_value = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Cloud_%28fixed_width%29.svg/2048px-Cloud_%28fixed_width%29.svg.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "cloud");
    			attr_dev(img, "class", "svelte-1hbxe4z");
    			toggle_class(img, "uploadMode", /*upload*/ ctx[0] == true);
    			add_location(img, file$2, 64, 4, 1795);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*handleCloudClick*/ ctx[5](/*c*/ ctx[11]))) /*handleCloudClick*/ ctx[5](/*c*/ ctx[11]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(64:0) {#each coordinates as c}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, coordinate*/ 16388) {
    ...
    // (69:1) <Modal on:close="{() => showModal = false}">
    function create_default_slot$1(ctx) {
    	...
    	detail = new Detail({
    			props: {
    				coordinate: /*coordinate*/ ctx[2],
    				cloudRef: /*cloudRef*/ ctx[4]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*coordinate*/ 4) detail_changes.coordinate = /*coordinate*/ ctx[2];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(69:1) <Modal on:close=\\\"{() => showModal = false}\\\">",
    		ctx
    	});
    ...
    function create_header_slot$1(ctx) {
    	let h1;
    	let t_value = /*coordinate*/ ctx[2].titles[0].title + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 69, 8, 2180);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*coordinate*/ 4 && t_value !== (t_value = /*coordinate*/ ctx[2].titles[0].title + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	let each_value = /*coordinates*/ ctx[1];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*coordinates, upload, handleCloudClick*/ 35) {
    				each_value = /*coordinates*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('PinPoint', slots, []);
    	let { db } = $$props;
    	let { storage } = $$props;
    	let { upload } = $$props;
    	const cloudRef = Da(db, "clouds");
    	let coordinates = [];
    	let coordinate;
    	let titles = [];
    	let showModal = false;
    	...
    	function getQuerySnapshot() {
    		const q = Kh(cloudRef, Wh("createdAt", "desc"));

    		Rl(q, querySnapshot => {
    			querySnapshot.forEach(doc => {
    				const documentObj = { id: doc.id, ...doc.data() };
    			...
    			$$invalidate(1, coordinates);
    		});
    	}

    	function handleCloudClick(c) {
    		const q = Kh(Da(cloudRef, c.id, 'titles'));

    		Rl(q, querySnapshot => {
    			querySnapshot.forEach(doc => {
    				const titleObject = { id: doc.id, ...doc.data().title };
    				titles.push(titleObject);
    				titles = titles;
    				c.titles = titles;
    			});

    			$$invalidate(2, coordinate = c);
    	...
    	const writable_props = ['db', 'storage', 'upload'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<PinPoint> was created with unknown prop '${key}'`);
    	});

    	const close_handler = () => $$invalidate(3, showModal = false);

    	$$self.$$set = $$props => {
    		if ('db' in $$props) $$invalidate(6, db = $$props.db);
    		if ('storage' in $$props) $$invalidate(7, storage = $$props.storage);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('storage' in $$props) $$invalidate(7, storage = $$props.storage);
    		if ('upload' in $$props) $$invalidate(0, upload = $$props.upload);
    		if ('coordinates' in $$props) $$invalidate(1, coordinates = $$props.coordinates);
    		if ('coordinate' in $$props) $$invalidate(2, coordinate = $$props.coordinate);
    ...
    class PinPoint extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { db: 6, storage: 7, upload: 0 });
    		...
    		if (/*db*/ ctx[6] === undefined && !('db' in props)) {
    			console.warn("<PinPoint> was created without expected prop 'db'");
    		}

    		if (/*storage*/ ctx[7] === undefined && !('storage' in props)) {
    			console.warn("<PinPoint> was created without expected prop 'storage'");
    		}

    		if (/*upload*/ ctx[0] === undefined && !('upload' in props)) {
    			console.warn("<PinPoint> was created without expected prop 'upload'");
    		}
    	}

    	get db() {
    		throw new Error("<PinPoint>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set db(value) {
    		throw new Error("<PinPoint>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/UploadForm.svelte generated by Svelte v3.49.0 */
    const file$1 = "src/UploadForm.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 43, 4, 1129);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "title");
    			attr_dev(input0, "id", "title");
    			input0.required = true;
    			add_location(input0, file$1, 44, 4, 1166);
    			attr_dev(label1, "for", "image");
    			add_location(label1, file$1, 46, 4, 1224);
    			attr_dev(input1, "type", "file");
    			attr_dev(input1, "name", "image");
    			attr_dev(input1, "id", "image");
    			attr_dev(input1, "accept", "image/*");
    			input1.required = true;
    			add_location(input1, file$1, 47, 4, 1261);
    			attr_dev(img, "width", "500px");
    			if (!src_url_equal(img.src, img_src_value = /*src*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 49, 4, 1364);
    			add_location(hr, file$1, 51, 4, 1404);
    			attr_dev(button0, "type", "submit");
    			add_location(button0, file$1, 52, 4, 1413);
    			attr_dev(button1, "type", "button");
    			add_location(button1, file$1, 53, 4, 1455);
    			add_location(form, file$1, 42, 0, 1078);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input1, "change", /*handleImgUpload*/ ctx[3], false, false, false),
    					listen_dev(button1, "click", /*close*/ ctx[1], false, false, false),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('UploadForm', slots, []);
    	const dispatch = createEventDispatcher();
    	const close = () => dispatch('close');
    	let { coordinate } = $$props;
    	let title;
    	...
    	async function handleSubmit(event) {
    		...
    		const docID = xa(Da(db, 'clouds')).id;
    		await uploadBytes(ref(storage, docID), image);
    		await Il(xa(db, 'clouds', docID), { coordinate, createdAt: Date.now() });
    		const cloudRef = Da(db, 'clouds');
    		await Al(Da(cloudRef, docID, 'titles'), { title: { title, like: 1 } });
    	}

    	function handleImgUpload(event) {
    		image = event.target.files[0];
    		$$invalidate(0, src = URL.createObjectURL(image));
    	}

    	const writable_props = ['coordinate', 'db', 'storage'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<UploadForm> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('coordinate' in $$props) $$invalidate(4, coordinate = $$props.coordinate);
    		if ('db' in $$props) $$invalidate(5, db = $$props.db);
    		if ('storage' in $$props) $$invalidate(6, storage = $$props.storage);
    	};
    	...
    	return [src, close, handleSubmit, handleImgUpload, coordinate, db, storage];
    }

    class UploadForm extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { coordinate: 4, db: 5, storage: 6 });
    		...
    		if (/*coordinate*/ ctx[4] === undefined && !('coordinate' in props)) {
    			console.warn("<UploadForm> was created without expected prop 'coordinate'");
    		}

    		if (/*db*/ ctx[5] === undefined && !('db' in props)) {
    			console.warn("<UploadForm> was created without expected prop 'db'");
    		}

    		if (/*storage*/ ctx[6] === undefined && !('storage' in props)) {
    			console.warn("<UploadForm> was created without expected prop 'storage'");
    		}
    	}

    	get coordinate() {
    		throw new Error("<UploadForm>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set coordinate(value) {
    		throw new Error("<UploadForm>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_if_block(ctx) {
    	...
    	modal.$on("close", /*closeModal*/ ctx[6]);
    ...
    // (39:1) <Modal on:close="{closeModal}">
    function create_default_slot(ctx) {
    	...
    	uploadform = new UploadForm({
    			props: {
    				coordinate: /*coordinate*/ ctx[0],
    				db: /*db*/ ctx[3],
    				storage: /*storage*/ ctx[4]
    			},
    			$$inline: true
    		});

    	uploadform.$on("close", /*closeModal*/ ctx[6]);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(uploadform, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const uploadform_changes = {};
    			if (dirty & /*coordinate*/ 1) uploadform_changes.coordinate = /*coordinate*/ ctx[0];
    		...
    		d: function destroy(detaching) {
    			destroy_component(uploadform, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:1) <Modal on:close=\\\"{closeModal}\\\">",
    		ctx
    	});
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "UPLOAD";
    			attr_dev(h2, "slot", "header");
    			add_location(h2, file, 39, 2, 952);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	let button;
    	let t0_value = (/*upload*/ ctx[1] ? "cancel" : "+") + "";
    	let t0;
    	let t1;
    	let div;
    	let pinpoint;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			create_component(pinpoint.$$.fragment);
    			t2 = space();
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			attr_dev(button, "class", "svelte-jkhhl1");
    			add_location(button, file, 31, 0, 700);
    			attr_dev(div, "class", "svelte-jkhhl1");
    			toggle_class(div, "upload", /*upload*/ ctx[1] === true);
    			add_location(div, file, 33, 0, 776);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(pinpoint, div, null);
    			insert_dev(target, t2, anchor);
    			if (if_block) if_block.m(target, anchor);
    			insert_dev(target, if_block_anchor, anchor);
    			current = true;
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "click", /*popUpModal*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*upload*/ 2) && t0_value !== (t0_value = (/*upload*/ ctx[1] ? "cancel" : "+") + "")) set_data_dev(t0, t0_value);
    			const pinpoint_changes = {};
    			if (dirty & /*upload*/ 2) pinpoint_changes.upload = /*upload*/ ctx[1];
    			pinpoint.$set(pinpoint_changes);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(pinpoint.$$.fragment, local);
    			transition_in(if_block);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(pinpoint.$$.fragment, local);
    			transition_out(if_block);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function popUpModal(event) {
    		if (upload == true) {
    			...
    			$$invalidate(0, coordinate.x = event.clientX - 10, coordinate);

    			$$invalidate(0, coordinate.y = event.clientY - 10, coordinate);
    	...
    	const click_handler = () => $$invalidate(1, upload = !upload);
    	...
    	$$self.$inject_state = $$props => {
    		if ('coordinate' in $$props) $$invalidate(0, coordinate = $$props.coordinate);
    		if ('upload' in $$props) $$invalidate(1, upload = $$props.upload);
